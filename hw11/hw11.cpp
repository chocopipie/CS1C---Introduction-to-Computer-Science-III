...
{
    // sort number by odd and even (odd first,then even )
    return x % 2 == 0;
}
...
int main()
{
    ...
    // not allowed - different return type // [1.4] assign fcnPtr1 to point to boo
...
// Q#4
// function1() is the virtual function
// call D2::function1() because the dPtr points to D2 obj

// Q#5

// slicing object happens when assigning the derived class obj to base class obj (upcasting).
// since the base class doesn't have access to the private data members of 
// derived class, that part of derived class obj is sliced away. 
